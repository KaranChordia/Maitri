...
const worldDestinations = [
  ...
  },
  {
    ...
    icon: BookOpenText,
    color: "#8b61c8",
    prompt: "Enter the reading hall to open early story previews, letters, and keepsake moments.",
    description: "A lamp-lit reading hall where Manu's story, letters, and story objects feel sacred and central.",
  ...
  },
  {
    ...
    icon: Gift,
    color: "#f3a823",
    prompt: "Step into the keepsake market to preview story-led future add-on ideas.",
    description: "A tactile market where objects from Manu's world can become gifts, rituals, and keepsakes after the first box is validated.",
    ...
    infoLine: "Future keepsakes and story-led add-on ideas",
  },
  {
    id: "classroom",
    ...
    icon: UsersThree,
    color: "#ef6f8b",
    prompt: "Walk into the courtyard to imagine future read-alouds and values-led story circles.",
    description: "An open-air court for future library circles, classroom read-alouds, and gentle values-led reflection.",
    ...
    infoLine: "Reading circles and guided story prompts",
  },
  {
    id: "hillside",
...
const storyBooks = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        text: "Use these stickers to retell the story: Manu, Badal, Moropant, the river stone, the brush, brave words, and warm keepsake motifs.",
      },
      {
        page: 32,
    ...
    pages: [
      {
        ...
        text: "This future story idea follows Manu through a river festival where helping quietly matters more than being praised. It stays child-centered and gentle, like the first Manu story.",
      },
    ],
  },
  {
