...
const worldDestinations = [
  ...
  },
  {
    ...
    icon: UsersThree,
    color: "#ef6f8b",
    prompt: "Walk into the courtyard to share a story and pause over its values together.",
    description: "An open-air court for books, guided prompts, and gentle values-led reflection.",
    ...
    infoLine: "Books and guided story prompts",
  },
  {
    id: "hillside",
